package main.java.com.yorov.auth.config;
...
import main.java.com.yorov.auth.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	protected void loadConfig() {
        JsonConfigProviderFactory factory = new main.java.com.yorov.auth.config.RegularJsonConfigProviderFactory();
